...
public class OrphanProfileActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView=(ListView)findViewById(R.id.DonationSpinner) ;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.orphan_profile, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.addDonationrequest) {

            Intent intent=new Intent(getApplicationContext(),ImageActivity.class);
            startActivity(intent);
            // Handle the camera action
        } else if (id == R.id.viewDonations) {
